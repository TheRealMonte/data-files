...
This is the file used for the stats on the homepage

## SQL files

Message [the_real_monte](https://sh.itjust.works/u/the_real_monte) for the SQL files used to create user stats. Original data file posted by Grant can be found [here](https://cdn.sc07.company/canvas/2024/canvas-stripped.sql.txt)
